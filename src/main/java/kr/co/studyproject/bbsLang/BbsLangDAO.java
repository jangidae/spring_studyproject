...
public class BbsLangDAO {
	 ...
	 public ArrayList<BbsLangDTO> search(String word) {
		 ...
		 try {
	            ...
	            sql.append(" where wtitle like '%"+word+"%' or userid like '%"+word+"%' or wcontent like '%"+word+"%' "); // 제모그 작성자, 내용 검색
	    ...
	    private LinkedList<BbsLangDTO> make_list(ResultSet rs){  //  본글과 답글의 순서 재배치
	    	try {
