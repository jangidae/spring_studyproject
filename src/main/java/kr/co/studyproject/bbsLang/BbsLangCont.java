...
public class BbsLangCont {
	...
	public ModelAndView createProc(@ModelAttribute BbsLangDTO dto, HttpServletRequest req) {
	...
	public ModelAndView reply(@ModelAttribute BbsLangDTO dto, HttpServletRequest req) {
		ModelAndView mav = new ModelAndView();
		mav.setViewName("bbsLang/reply");
		dto.setIp(req.getRemoteAddr());
		dto.setUserid((String) req.getSession().getAttribute("s_userid"));
