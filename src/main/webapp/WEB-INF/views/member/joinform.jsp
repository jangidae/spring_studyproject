...
<form name="joinfrm" id="joinfrm" action="joinProc.do" onsubmit="return memberCheck()"><!-- myscript.js -->
<h4>회원가입</h4>
...
<tr>
    <th>*비밀번호 확인</th>
    <td style="text-align: left"><input type="password" name="upwcheck" id="upwcheck" size="15" required></td>
</tr>
<tr>
    <th>*이름</th>
...
<tr>
    <th>*이메일</th>
    <td style="text-align: left">
      <input type="email" name="email" id="email" size="30" placeholder=" ' @ ' 포함해서 입력" required readonly>
      <input type="button" value="Email 중복확인" onclick="emailCheck.do">
    </td>
</tr>
<tr>
    <th>*전화번호</th>
