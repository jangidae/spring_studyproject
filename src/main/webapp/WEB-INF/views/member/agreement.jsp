...
<link rel="stylesheet" href="../css/ag_base.css"> <!-- 6/22 적용했습니다 -->
<link rel="stylesheet" href="../css/ag_button.css"> <!-- 6/22 적용했습니다 -->
<link rel="stylesheet" href="../css/ag_join.css"> <!-- 6/22 적용했습니다 -->
<!-- 본문 시작 template.jsp -->

<form name="agrfrm" id="agrfrm" action="joinform.do" method="POST" onsubmit="return agreeCheck()">
...
제24조(재판권 및 준거법)
 ...
 ②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
            ...
            <tr>
              <td>
                <input type="checkbox" id="check_1">이용약관에 동의합니다.<br><br><br><br>
              </td>
            </tr>
            <tr>
              <td>
...
'정보통신망 이용촉진 및 정보보호 등에 관한 법률'의 거래기록 보존 의무에 따른 보존: 1년
            ...
            <tr>
              <td>
                <input type="checkbox" id="check_2">개인정보 수집 및 이용에 대한 안내에 동의합니다.
              </td>
            </tr>
          </table>
...
<br><br>
  <button type = "submit"  id="agreebtn" name="agreebtn" class="btn_order" style="margin:10px;">회 원 가 입</button>
